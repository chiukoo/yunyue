...
if(isset($_POST['send_data'])&&$_POST['send_data']=='has_post_value'){
	...
	$insert_sql_dsc = "insert into `sys_index` set `title`='".$_POST['title']."',`content`='".$_POST['content1']."',`order`='".$_POST['order']."',`img`='".$img."',`url`='".$_POST['url']."',`create_dt`='".$updateDsc."'";
...
<div id="container">
  ...
  <div class="breadcrumb">
        <a href="index.php">首頁(Home)</a> :: <a href="sys_list.php">主頁</a> :: <a href="#">新增主頁</a>
      </div>
    <div class="box">
    <div class="heading">
