<?php
 ...
 //宣告變數 ----------------------------------------------------------------------------
	...
	if(isset($_POST['send_data'])&&$_POST['send_data']=='has_post_value' ){
      ...
      $up_dsc ="update `content` set `content`='".$_POST['content']."',`edit_dt`='".$edit."' where `id`='1'";
      $res=$ODb->query($up_dsc) or die("更新資料出錯，請聯繫管理員。");
    
			
		ri_jump("about_us.php");	
  }

	$sql_dsc = "select * from `content` where `id`=1 ";
...
<div id="container">
  ...
  <div class="breadcrumb">
        <a href="./index.php">首頁(Home)</a> :: <a href="#">關於我們設定</a>
      </div>
    <div class="box">
    <div class="heading">
      <h1><img src="./image/category.png" alt="" />關於我們</h1>
