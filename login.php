...
<body>
    ...
    <div id="loginbox">
        ...
        <img src="images/title.png"  class="title"/>
            ...
            <li id="captcha"><?php $captcha = new CaptchaImage(120,50,4,'ebebeb','333333','999999');?><span class="fixbtn"><a onclick="chk()" class="btn">登入</a></span></li>
			<input name="recaptcha" type="hidden" value="<?php echo $_SESSION['captcha_code'];?>" />
