...
<div id="container">
 <?php
  ...
  <div id="content">
    ...
    <div class="box">
    <div class="heading">
      <h1><img src="image/category.png" alt="" />統計報表管理 - 網站分析統計 Breaking info</h1><a href="skype:snow20822?call" on-click="return skypeCheck();"><img src=http://mystatus.skype.com/smallclassic/worldshop668 style="border: none;" alt= "Call me!" /></a>
      <a target="blank" href="http://wpa.qq.com/msgrd?V=1&Uin=1505600116&Site=台灣雲端& Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:1505600116:6 alt="點擊這裏給我發消息" align="absmiddle"></a>
