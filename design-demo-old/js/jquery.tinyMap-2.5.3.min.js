...
MarkerDirect:function(a){var b=this,c,d;d={map:this.map,position:new google.maps.LatLng(a.addr[0],a.addr[1]),title:a.text.replace(/<([^>]+)>/g,""),infoWindow:new google.maps.InfoWindow({content:a.text})};var f={},f={};"string"===typeof a.icon?d.icon=a.icon:h(a.icon,"url")&&(f=h(a.icon,"anchor")&&e!==a.icon.anchor[1]?new google.maps.Point(a.icon.anchor[0],a.icon.anchor[1]):new google.maps.Point(0,0),console.log(f),f=new google.maps.MarkerImage(a.icon.url,null,new google.maps.Point(0,0),f),d.icon=f);
c=new google.maps.Marker(d);this._markers.push(c);h(c,"position")&&c.getPosition().lat()&&c.getPosition().lng()&&b.bounds.extend(d.position);d={map:this.map,css:e!==a.css?a.css:""};"string"===typeof a.label&&0!==a.label.length&&(d.text=a.label);a=new k(d);a.bindTo("position",c,"position");a.bindTo("text",c,"position");a.bindTo("visible",c);google.maps.event.addListener(c,"click",function(){c.infoWindow.open(b.map,c)})},MarkerByGeocoder:function(a){var b=this;(new google.maps.Geocoder).geocode({address:a.addr},
function(c,d){if(d===google.maps.GeocoderStatus.OVER_QUERY_LIMIT)l.setTimeout(function(){b.MarkerByGeocoder(a)},this.interval);else if(d===google.maps.GeocoderStatus.OK){var f,e;e={map:b.map,position:c[0].geometry.location,title:a.text.replace(/<([^>]+)>/g,""),infoWindow:new google.maps.InfoWindow({content:a.text})};"string"===typeof a.icon&&(e.icon=a.icon);f=new google.maps.Marker(e);b._markers.push(f);h(f,"position")&&f.getPosition().lat()&&f.getPosition().lng()&&b.bounds.extend(e.position);e={map:b.map,
css:a.css||""};"string"===typeof a.label&&0!==a.label.length&&(e.text=a.label);e=new k(e);e.bindTo("position",f,"position");e.bindTo("text",f,"position");e.bindTo("visible",f);google.maps.event.addListener(f,"click",function(){f.infoWindow.open(b.map,f)})}})},DirectionService:function(a){var b=[],c=new google.maps.DirectionsService,d=new google.maps.DirectionsRenderer,f={travelMode:google.maps.DirectionsTravelMode.DRIVING,optimizeWaypoints:a.optimize||!1},g=0,h=0;"string"===typeof a.from&&(f.origin=
a.from);"string"===typeof a.to&&(f.destination=a.to);"string"===typeof a.travel&&0<a.travel.length&&(f.travelMode=google.maps.DirectionsTravelMode[a.travel.toUpperCase()]);if(e!==a.waypoint&&0!==a.waypoint){g=0;for(h=a.waypoint.length;g<h;g+=1)b.push({location:a.waypoint[g].toString(),stopover:!0});f.waypoints=b}e!==f.origin&&e!==f.destination&&(c.route(f,function(a,b){b===google.maps.DirectionsStatus.OK&&d.setDirections(a)}),d.setMap(this.map),this._directions.push(d))},init:function(){var a=this,
b;n+=1;"string"===typeof this.options.center?l.setTimeout(function(){var c=g(a.container),d="";b=new google.maps.Geocoder;b.geocode({address:a.options.center},function(b,g){try{g===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?a.init():g===google.maps.GeocoderStatus.OK&&0!==b.length?(a.GoogleMapOptions.center=g===google.maps.GeocoderStatus.OK&&0!==b.length?b[0].geometry.location:"",a.map=new google.maps.Map(a.container,a.GoogleMapOptions),google.maps.event.addListenerOnce(a.map,"idle",function(){a.overlay();
a.options.marker.length&&!0===a.options.markerFitBounds&&setTimeout(function(){a.map.fitBounds(a.bounds)},this.interval)})):(d=a.options.notfound.text||g,c.html(d.replace(/</g,"&lt;").replace(/>/g,"&gt;")))}catch(h){c.html((e!==h.message?h.message:h.description).toString())}})},this.interval*n):(a.map=new google.maps.Map(a.container,a.GoogleMapOptions),google.maps.event.addListenerOnce(a.map,"idle",function(){a.overlay();a.options.marker.length&&!0===a.options.markerFitBounds&&a.map.fitBounds(a.bounds)}))},
panto:function(a){var b=this,c;h(b,"map")&&null!==b.map&&e!==b.map&&("string"===typeof a?(-1!==a.indexOf(",")&&(c="loc: "+a),c=new google.maps.Geocoder,c.geocode({address:a},function(a,c){c===google.maps.GeocoderStatus.OK&&g.isFunction(b.map.panTo)&&e!==a[0]&&b.map.panTo(a[0].geometry.location)})):("[object Array]"===Object.prototype.toString.call(a)?2===a.length&&(c=new google.maps.LatLng(a[0],a[1])):h(a,"lat")&&h(a,"lng")?c=new google.maps.LatLng(a.lat,a.lng):h(a,"x")&&h(a,"y")&&(c=new google.maps.LatLng(a.x,
a.y)),g.isFunction(b.map.panTo)&&e!==c&&b.map.panTo(c)))},clear:function(a){var b,c,d;"string"===typeof a&&(b=a.split(","));for(c=0;c<b.length;c+=1)if(a="_"+g.trim(b[c].toString().toLowerCase())+"s",e!==this[a]&&this[a].length){for(d=0;d<this[a].length;d+=1)this[a][d].set("visible",!1),this[a][d].setMap(null);this[a]=[]}},modify:function(a){var b=[],c=[["kml","kml"],["marker","markers"],["direction","direction"],["polyline","DrawPolyline"],["polygon","DrawPolygon"],["circle","DrawCircle"],["zoom",
"setZoom"]],d;if(e!==a){for(d=0;d<c.length;d+=1)h(a,c[d][0])&&b.push(c[d][1]);if(null!==this.map&&e!==this.map&&b)for(d=0;d<b.length;d+=1)if("function"===typeof this[b[d]])this[b[d]](this.map,a)}}};g.fn.tinyMap=function(a){var b=arguments,c,d;return"string"===typeof a?(this.each(function(){d=g.data(this,"tinyMap");d instanceof m&&"function"===typeof d[a]&&(c=d[a].apply(d,Array.prototype.slice.call(b,1)))}),e!==c?c:this):this.each(function(){g.data(this,"tinyMap")||g.data(this,"tinyMap",new m(this,
